...
function HaLongresorts({ src, titleBlog, info, timeUp }) {
    return (
        <div className="containerr py-20">
            <h1>I. FLC Grand Hạ Long</h1>
            <p><b>Địa chỉ</b>: Đường Nguyễn Văn Cừ, phường Hồng Hải, Thành phố Hạ Long</p>
            <img className="img-article" src={"../image/resorts/resort01.jpg"} alt=""/>
            ...
            <img className="img-article" src={"../image/resorts/resort01a.jpg"}></img>
            <img className="img-article" src={"../image/resorts/resort01b.jpg"}></img>
            ...
            <img className="img-article" src={"../image/resorts/resort01c.jpg"}></img>
            ...
            <img className="img-article" src={"../image/resorts/resort01d.jpg"}></img>
            ...
            <br />
            <h1>II. Vinpearl Hạ Long</h1>
            <p><b>Địa chỉ</b>: Đảo Rều, Thành phố Hạ Long, Quảng Ninh</p>
            <img className="img-article" src={"../image/resorts/resort02.jpg"}></img>
            <p>Lấy cảm hứng từ các tác phẩm nghệ thuật và kiến ​​trúc Pháp, Vinpearl Hạ Long Resort mang đến cho du khách nơi nghỉ dưỡng sang trọng với thiết kế hình cánh cung trang nhã. Nhìn từ xa, khu nghỉ dưỡng như một vương quốc thu nhỏ, nguy nga và xinh đẹp sừng sững giữa trung tâm Vịnh Hạ Long – kỳ quan thiên nhiên thế giới.</p>
            <img className="img-article" src={"../image/resorts/resort02a.jpg"}></img>
            <p>Với diện tích lên đến 47 000m2, khu nghỉ dưỡng có đến 384 phòng nghỉ với nhiều hạng phòng khác nhau, phù hợp cho nhiều nhu cầu và nhiều đối tượng.</p>
            <p>Vinpearl Hạ Long không chỉ phù hợp để nghỉ dưỡng, nơi đây còn là địa điểm lý tưởng để bạn có thể trải nghiệm những tiện ích dịch vụ cao cấp, chuẩn 5 sao quốc tế.</p>
            <br />
            <h1>III. Premier Village Ha Long Bay Resort</h1>
            <p><b>Địa chỉ</b>: 9 đường Hạ Long, Thành phố Hạ Long</p>
            <img className="img-article" src={"../image/resorts/resort03.jpg"}></img>
            <p>Với không gian và thiết kế đón gió biển trong lành cùng với những tiện ích như hồ bơi riêng, biệt thự nghỉ dưỡng sang trọng sẽ đem đến cho bạn và gia đình cảm giác được hòa mình vào sự tươi mát của cỏ cây, hoa lá và đắm mình thư giãn trong tiếng sóng biển rì rào.</p>
            <img className="img-article" src={"../image/resorts/resort03a.jpg"}></img>
            <img className="img-article" src={"../image/resorts/resort03b.jpg"}></img>
            <p>Những căn biệt thự sang trọng của Premier Village Ha Long Bay được thiết kế tràn đầy cảm hứng để hòa nhịp trọn vẹn với vẻ đẹp nhiệt đới bên bờ vịnh.</p>
            <img className="img-article" src={"../image/resorts/resort03c.jpg"}></img>
            <img className="img-article" src={"../image/resorts/resort03d.jpg"}></img>
            <p>Trải nghiệm những màn trình diễn ẩm thực sống động và tương tác trực tiếp với các đầu bếp hàng đầu.</p>
            <img className="img-article" src={"../image/resorts/resort03e.jpg"}></img>
            <p>Cung cấp phòng các phòng massage trị liệu đôi và đơn. Đặc quyền sử dụng bể bơi và spa với trang thiết bị tiện nghi.</p>
            <br />
            <h1>IV. Royal Lotus Ha Long Resort & Villas</h1>
            <p><b>Địa chỉ</b>: Bán Đảo 2, Đường Hùng Thắng, Thành phố Hạ Long</p>
            <img className="img-article" src={"../image/resorts/resort04.jpg"}></img>
            ...
            <img className="img-article" src={"../image/resorts/resort04a.jpg"}></img>
            ...
            <img className="img-article" src={"../image/resorts/resort04b.jpg"}></img>
            ...
            <img className="img-article" src={"../image/resorts/resort04c.jpg"}></img>
            <img className="img-article" src={"../image/resorts/resort04d.jpg"}></img>
            ...
            <img className="img-article" src={"../image/resorts/resort05.jpg"}></img>
            ...
            <img className="img-article" src={"../image/resorts/resort05a.jpg"}></img>
            ...
            <img className="img-article" src={"../image/resorts/resort05b.jpg"}></img>
            <img className="img-article" src={"../image/resorts/resort05c.jpg"}></img>
            ...
            <img className="img-article" src={"../image/resorts/resort05d.jpg"}></img>
